                        ...
                        <React.Fragment key={index}>
                            ...
                            {index < dates.length - 1 && (
                                <Separator
                                    ...
                                    className="w-0.5 h-10 lg:mr-0.5 lg:ml-0.5"
                                />
                            )}
                        </React.Fragment>
                    ))}
                    ...
                    <Select className="w-full lg:w-auto border border-[#A06ECE] rounded-3xl">
                        ...
                        <SelectContent className="text-[#A06ECE] bg-white border border-[#A06ECE] rounded-xl">
                            <SelectGroup>
                                <SelectItem
                                    value="Termurah"
                                    className="flex items-center focus:bg-[#7126B5]"
                                >
                                    <b>Harga</b> - Termurah
                                </SelectItem>
