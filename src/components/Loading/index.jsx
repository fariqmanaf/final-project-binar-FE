export const Loading = () => {
  return (
    <div className="flex flex-col items-center justify-center space-y-4">
      <p className="text-[2.5vh] font-light animate-blink">Mencari penerbangan terbaik...</p>
      <div className="relative w-[20vw] h-[8vh] bg-gray-200 rounded-xl overflow-hidden border-2 border-gray-300">
