  ...
  return (
    <div className="w-full border border-slate-200 rounded-[2rem] shadow-lg">
      ...
      <div className="flex  gap-[1rem] items-center h-[10vh] p-[3vw]">
        <div className="bg-[#A06ECE] px-[1rem] py-[0.5rem] text-[2vh] rounded-[1rem] text-white font-semibold">1</div>
        <div className="">
      ...
      {RD !== null && (
        <div className={`${DF === null ? 'opacity-50' : 'opacity-100'} flex gap-[1rem] items-center h-[10vh] p-[3vw]`}>
          <div className="bg-[#A06ECE] px-[1rem] py-[0.5rem] text-[2vh] rounded-[1rem] text-white font-semibold">2</div>
          <div className="">
